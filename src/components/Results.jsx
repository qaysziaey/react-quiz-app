...
import { data_of_questions } from "../data/data.js";
  ...
  let Max_points = data_of_questions.prizes_by_points[data_of_questions.prizes_by_points.length-1].end
  let resultPriseText = ''
  ...
  return (
    <>
      ...
      <div className={styles.table_of_results}>
        ...
        {users.map((person) => {
          return (
            <div className={styles.table_person+' '+(person.avatar==user.avatar && person.username==user.username?styles.thisUser:'')}>
