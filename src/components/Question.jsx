 ...
 //   console.log(user)
   ...
   // console.log(currentQuestionIndex)
    ...
    if(answers[0]==undefined){
        ...
        data_of_questions.questions[currentQuestionIndex].answers.forEach((value, index) => {
  ...
  //  console.log(temp_user_answers)
    ...
    const onCheckAnswer = (value) => {
        ...
        if(data_of_questions.questions[currentQuestionIndex].answers[value].richtich){
            temp_user_answers[currentQuestionIndex] = data_of_questions.questions[currentQuestionIndex].question.points_for_right_answer;
   ...
   // console.log(temp_user_answers)
    ...
    <div className={styles["questions-container"]}>
        ...
        <h2 className={styles["rounds-counter"]}>{currentQuestion.id}/{data_of_questions.questions.length}</h2>
        ...
        <form>
            ...
            <label key={answer.number} className={styles["answer"]}>
                <input
                    ...
                    type="radio"
                    value={key}
                    checked={temp_checkBoxState[currentQuestionIndex]==key?true:false}
        ...
        <button className="button" onClick={() => {
                    ...
                    {currentQuestionIndex>=data_of_questions.questions.length-1?'Finish':'Next'}
                </button>
        </div>
    </div>
    </>
